...
import { Globe, ShoppingCart, Mail, Lock, User, ArrowRight, Check } from "lucide-react";
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Comece a clonar ofertas de sucesso agora</p>
          </div>

          {/* Benefits */}
          <div className="mb-6 space-y-3">
            {[
              "1 produto grátis para testar",
              "Sem cartão de crédito necessário",
              "Acesso imediato às estratégias"
            ].map((benefit, index) => (
